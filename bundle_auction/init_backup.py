...
CORRECT_ANSWERS = {
    ...
    'q9': '11 points ($8 - (-3))',
    'q10': 'Zero points',
    'q11': 'Both A and B are valid options',
    'q12': 'Both A and B are valid options',
...
class Player(BasePlayer):
    ...
    q1 = models.StringField(
        label="1. What is your main objective in the experiment?",
        choices=[
    ...
    q2 = models.StringField(
        label="2. Do profits earned during the practice rounds count toward your final cash earnings?",
        choices=['Yes', 'No'],
        widget=widgets.RadioSelect
    )
    q3 = models.StringField(
        label="3. Will your role (Buyer or Seller) change between trading rounds?",
        choices=[
    ...
    q4 = models.StringField(
        label="4. What is the conversion rate for your total earnings at the end of the experiment?",
        choices=[
    ...
    q5 = models.StringField(
        label="5. [Buyers] If the first unit of a product you buy has a value of $20, what happens to the value of the second unit of that same product?",
        choices=[
    ...
    q6 = models.StringField(
        label="6. [Sellers] If the first unit of a product you sell costs $5 to produce, what happens to the cost of the second unit of that same product?",
        choices=[
    ...
    q7 = models.StringField(
        label="7. [Buyers] If you buy a unit with a Value of 15 points at a Price of 9 points, what is your transaction profit?",
        choices=['24 points', '6 points', '-6 points'],
        widget=widgets.RadioSelect
    )
    q8 = models.StringField(
        label="8. [Sellers] If you sell a unit with a Cost of 4 points at a Price of 10 points, what is your transaction profit?",
        choices=['14 points', '6 points', '40 points'],
        widget=widgets.RadioSelect
    )
    q9 = models.StringField(
        label="9. [Sellers] Suppose a unit displays a negative cost of -$3 points (a production bonus). If you sell this unit for a price of 8 points, what is your profit?",
        choices=['5 points ($8 - 3)', '11 points ($8 - (-3))', '-5 points'],
        widget=widgets.RadioSelect
    )
    q10 = models.StringField(
        label="10. If you complete no trades in a round, what is your profit for that round?",
        choices=['Zero points', '-10 points', 'Equal to your initial participation fee'],
        widget=widgets.RadioSelect
    )
    q11 = models.StringField(
        label="11. [Buyers] How can you execute a trade during a round?",
        choices=[
            'Type a price into the box and click Submit Bid',
            'Click the Buy button next to a seller\'s price to instantly buy',
            'Both A and B are valid options',
            'Wait for the computer to automatically trade for you'
        ],
        widget=widgets.RadioSelect
    )
    q12 = models.StringField(
        label="12. [Sellers] How can you execute a trade during a round?",
        choices=[
            'Type a price into the box and click Submit Ask',
            'Click the Sell button next to a buyer\'s price to instantly sell',
            'Both A and B are valid options',
            'Wait for the computer to automatically trade for you'
        ],
        widget=widgets.RadioSelect
    ...
    q13 = models.StringField(
        label="13. [Buyers] To submit a new Bid (buy offer) that appears on the market, your offer must be:",
        choices=[
    ...
    q14 = models.StringField(
        label="14. [Sellers] To submit a new Ask (sell offer) that appears on the market, your offer must be:",
        choices=[
    ...
    q15 = models.StringField(
        label="15. [Sellers - Baseline Treatment] What happens to your production cost for Product B when you sell a unit of Product A?",
        choices=[
    ...
    q16 = models.StringField(
        label="16. [Package Menu Treatment] Are the amounts/ratios of products inside packages guaranteed to remain the same across all rounds?",
        choices=[
...
class Quiz(Page):
    ...
    def get_form_fields(player: Player):
        ...
        # Only render questions that haven't been passed yet
...
# page_sequence = [Welcome, Quiz, ReadyToStart, Trading, BetweenRounds, FinalResults, Questionnaire]
